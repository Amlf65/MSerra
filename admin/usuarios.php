          ...
          <table class="table table-hover table-responsive-sm">
            ...
            <tbody>
              <tr>
                ...
                ?>
                  <td>
                    <img src="../images/<?php echo $f['img_perfil']; ?>" width="50px" alt="<?php echo $f['img_perfil']; ?>">
                  </td>
                  <td>
                    <?php echo $f['id']; ?>
                  </td>
                  ...
                  <td>
                    ...
                    data-user="<?php echo $f['user']; ?>" 
                    data-dpto="<?php echo $f['departamento']; ?>" 
          ...
          <form action="../php/insertarUsuario.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="file" name="imagen" id="imagen" placeholder="Imagen" class="form-control" required>
                <label for="usuario">Usuario</label>
                <input type="text" name="user" id="usuario" placeholder="Usuario" class="form-control" required>
                ...
                <input type="text" name="dpto" id="dpto" placeholder="Departamento" class="form-control" required>
                <label for="clave">E-mail</label>
                <input type="text" name="email" id="email" placeholder="E-mail" class="form-control" required>
                <label for="nivel">Nivel</label>
                <select name="nivel" id="colorEdit" class="form-control" required>
          ...
          <form action="../php/editarUsuario.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="file" name="imagen" id="imagenEdit" placeholder="Imagen" class="form-control" required>
                <label for="usuarioEdit">Usuario</label>
                <input type="text" name="user" id="usuarioEdit" placeholder="Usuario" class="form-control" required>
                <label for="claveEdit">Password</label>
                <input type="password" name="clave" id="claveEdit" placeholder="Password" class="form-control" required>
                <label for="clave">Departamento</label>
                <input type="text" name="dpto" id="dptoEdit" placeholder="Departamento" class="form-control" required>
                <label for="clave">E-mail</label>
                <input type="text" name="email" id="emailEdit" placeholder="E-mail" class="form-control" required>
